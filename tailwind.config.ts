  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        heading: ['var(--font-nunito)', 'PingFang SC', 'Microsoft YaHei', 'sans-serif'],
        nunito: ['var(--font-nunito)', 'sans-serif'],
        rounded: ['-apple-system', 'BlinkMacSystemFont', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'sans-serif'],
      },
      letterSpacing: {
        tight: '-0.025em',
      },
